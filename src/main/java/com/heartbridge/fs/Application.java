package com.heartbridge.fs;

import com.heartbridge.fs.server.FileServer;
...
public class Application {
    ...
    public static void main(String[] args) throws InterruptedException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        Class<Server> serverClass = (Class<Server>) Class.forName("com.heartbridge.fs.server.FileServer");
